            ...
            while True:
                ...
                if len(header) > 0:
                    ...
                    if packet_id in packets:
                        ...
                        if packet_id == 10101:
                            if len(str(signer))!=8:
                                connected.remove(self.address[0])
                                os.system(f'sudo iptables -t filter -A INPUT -s {self.address[0]} -j DROP')
                                self.client.close()
                                break
