...
class LogicDailyData:
    ...
    def encode(self):
        ...
        self.writeVInt(int(self.player.trophies))  # Trophy Road Reached Icon
        ...
        self.writeVInt(Helpers.timerglobal(self, [0, 0, 0], [12, 18, 3]))  # Brawl Pass Timer
