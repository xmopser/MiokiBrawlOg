...
class Player:
    ...
    brawlers_rare = [2, 6, 8, 10, 13, 22]
    brawlers_superrare = [3, 4, 7, 9, 18, 19]
    brawlers_epic = [1, 15, 16, 20, 26, 27, 49]
    brawlers_megaepic = [11, 14, 17, 21, 31, 37]
    brawlers_legendary = [5, 12, 23]
    ban = False
    ban_reason = False
    account_type = "Player"
    test_state = True
